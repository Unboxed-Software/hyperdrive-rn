...
type Props = {
  onSubmit: (_f: { fields: Pick<VirtualAddress, 'title' | 'description'> }) => Promise<unknown>;
  onClose: () => void;
  isOpen: boolean;
...
const EditVirtualAddressModal: React.FC<Props> = ({ onSubmit, isOpen, title, description, onClose }) => {
...
export default EditVirtualAddressModal;
